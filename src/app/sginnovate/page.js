...
export default function page() {
    ...
    there is still untapped potential to strengthen and increase interactions in the Deep-tech economy in Singapore.
            ...
            >
                ...
                <img className={styles.picture} src={`${process.env.NODE_ENV === "development" ? "" : "/AnnetteLoke"}/sginnovate_design_process.png`} />
                <p className={styles.text}>
    ...
    with the Lead Designer, and <strong>iterated</strong> my designs until they were ready to be used.
            ...
            >
                ...
                <img className={styles.picture} src={`${process.env.NODE_ENV === "development" ? "" : "/AnnetteLoke"}/design_sample_e-learning.png`} />
            </div>
            <div
                ref={section6Ref}
            ...
            >
                ...
                <img className={styles.picture} src={`${process.env.NODE_ENV === "development" ? "" : "/AnnetteLoke"}/design_sample_interest-group.png`} />
                <p className={styles.subtitle}>
                    Proposed “Main Page” of the interest group module
                </p>
                <img className={styles.picture} src={`${process.env.NODE_ENV === "development" ? "" : "/AnnetteLoke"}/design_sample_inside-interest-group.png`} />
                <p className={styles.subtitle}>
